...
public class ModBlockEntities {
    ...
    public static final BlockEntityType<ReinforcedBlockEntity> REINFORCED = register("reinforced", ReinforcedBlockEntity::new,ModBlocks.DEBUG_REINFORCED_BLOCK,ModBlocks.REINFORCED_DOOR_BLOCK,ModBlocks.REINFORCED_FENCE_GATE,ModBlocks.REINFORCED_FENCE_GATE,ModBlocks.REINFORCED_IRON_BLOCK);
